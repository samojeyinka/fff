...
export default function Index() {
  ...
  return (
    <>
      <nav className="border-gray-200 bg-[#EEF5F0] px-2 pt-3 md:mx-0 md:px-0 md:pt-3">
        <div className="flex max-w-screen-xl flex-wrap items-center justify-between sm:justify-start">
          <div className=" ml-4 mt-[-10px] sm:text-2xl md:ml-0 md:pl-5 md:pr-20 md:pt-2 lg:pl-10 lg:pr-32 lg:pt-0 xl:ml-[150px]">
            <a href="/#top">
          ...
          >
            <ul className="ml-4 flex flex-col rounded-lg border border-gray-100 font-normal md:ml-0 md:mt-0 md:flex-row md:space-x-8 md:border-0 md:p-0 md:dark:bg-gray-900 rtl:space-x-reverse">
              ...
              <li className="py-5 lg:pl-48 xl:pl-60">
                <a
                  href="/dashboard"
                ...
                >
                  <span className="rounded-3xl border-solid bg-[#174568] px-3 py-2.5 text-white">
